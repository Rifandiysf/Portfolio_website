  ...
  return (
    <section className='flex flex-col p-10 min-h-screen' id='#about'>
      ...
      <div className='grid grid-cols-2 justify-center items-center w-full h-[540px] phone:grid-cols-1 tablet:grid-cols-2'>
        <img src={Picture} alt="Profile Picture" className='w-[30rem] flex justify-center items-center phone:w-[15rem] laptop:w-[30rem]' data-aos="fade-right" data-aos-offset="300" data-aos-easing="ease-in-sine"/>
