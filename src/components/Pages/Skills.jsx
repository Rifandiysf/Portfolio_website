      ...
      <h1 className="font-extrabold text-Title text-2xl mb-5 phone:text-xl laptop:text-2xl" data-aos="fade-right" data-aos-easing="ease-in-sine">Skills</h1>
        <div className='flex flex-col justify-center items-center mt-10'>
          ...
          <div className='flex gap-5 phone:flex-col tablet:flex-row'>
            <div className="flex flex-col justify-center items-center" data-aos="fade-right" data-aos-easing="ease-in-sine" data-aos-delay="300">
              <AppWindow size={32}/>
              <h3 className="text-xl font-semibold phone:text-base tablet:text-lg laptop:text-xl">Web Design</h3>
            </div>
            <div className="flex flex-col justify-center items-center" data-aos="fade-zoom-in"  data-aos-easing="ease-in-back" data-aos-delay="300">
              <MonitorSmartphone size={32}/>
              <h3 className="text-xl font-semibold phone:text-base tablet:text-lg laptop:text-xl">Responsive Layout</h3>
            </div>
            <div className="flex flex-col justify-center items-center" data-aos="fade-left" data-aos-easing="ease-in-sine" data-aos-delay="300">
              <PhoneCall size={32}/>
